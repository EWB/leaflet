...
<body class="<?php print $body_classes; ?>">
  ...
  <?php if ($primary_links): ?>
    <div id="page-outer">
      ...
      <a href="<?php print base_path(); ?>" title="Digital Collections Home">Digital Collections @ St. Lawrence University</a>
    </div> <!-- /#page-outer -->
  <?php endif; ?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($logo): ?>
        <a href="<?php print "http://digitalcollections.stlawu.edu/collections/frederic-remington-collection"; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
      <?php endif; ?>
          ...
          <?php if ($site_name): ?>
            <?php if ($title): ?>
              <div id="site-name"><strong>
                <a href="<?php print "http://digitalcollections.stlawu.edu/collections/frederic-remington-collection"; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a>
              </strong></div>
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <?php /*if ($primary_links || $navigation): ?>
        ...
        <?php /*print theme(array('links__system_main_menu', 'links'), $primary_links,
            ...
            ));*/ //ewb - commented out the above lines in order to keep the primary links from showing up twice
          ?>  
