...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($logo): ?>
        <a href="<?php print "http://digitalcollections.stlawu.edu/collections/slu-photographs"; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
      <?php endif; ?>
          ...
          <?php if ($site_name): ?>
            <?php if ($title): ?>
              <div id="site-name"><strong>
                <a href="<?php print "http://digitalcollections.stlawu.edu/collections/slu-photographs"; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a>
              </strong></div>
